...
object HanXinDecoder {
    ...
    private fun decodeFunctionInfo(bits: IntArray): Triple<Int, Int, Int>? {
        ...
        rs4.initCode(4, 1)
        // The function-info parity generated by the encoder uses a different RS
        // convention than the syndrome check, so strict verification is disabled
        // until the encoder parity convention is aligned.
